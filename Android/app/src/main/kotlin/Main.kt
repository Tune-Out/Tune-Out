...
internal val logger: SkipLogger = SkipLogger(subsystem = "tune.out", category = "TuneOut")

private typealias AppRootView = TuneOutRootView
private typealias AppDelegate = TuneOutAppDelegate
