...
//    }
    ...
    @MainActor func testCollections() throws {
        ...
        let station1 = StationInfo(stationuuid: UUID(uuidString: "00000000-0000-0000-0000-000000000001")!, name: "Station 1", url: "https://radio-browser.info")
        let station2 = StationInfo(stationuuid: UUID(uuidString: "00000000-0000-0000-0000-000000000002")!, name: "Station 1", url: "https://radio-browser.info")
        let station3 = StationInfo(stationuuid: UUID(uuidString: "00000000-0000-0000-0000-000000000003")!, name: "Station 1", url: "https://radio-browser.info")
        let station4 = StationInfo(stationuuid: UUID(uuidString: "00000000-0000-0000-0000-000000000004")!, name: "Station 1", url: "https://radio-browser.info")
        let station5 = StationInfo(stationuuid: UUID(uuidString: "00000000-0000-0000-0000-000000000005")!, name: "Station 1", url: "https://radio-browser.info")

//        var collection1 = CollectionInfo(name: "Collection 1")
//
//        viewModel.addCollection(collection1)
//        XCTAssertEquals(1, viewModel.collections.count)
//
//        viewModel.addStation(station1, to: collection1)
//        viewModel.addStation(station2, to: collection1)
//        XCTAssertEquals(2, viewModel.stations(in: collection1).count)
//
//        viewModel.removeStation(station2, from: collection1)
//        XCTAssertEquals(1, viewModel.stations(in: collection1).count)
//
//        viewModel.removeCollection(collection1)
//        XCTAssertEquals(0, viewModel.collections.count)
    }
}
